...
class UParticleLODLevel : public UObject
{
	 ...
	 */
	void GetUsedMaterials( TArray<UMaterialInterface*>& OutMaterials, const TArray<struct FNamedEmitterMaterial>& NamedMaterialSlots, const class UParticleSystemComponent* InComponent) const;
};
